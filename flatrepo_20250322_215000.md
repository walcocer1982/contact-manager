...
repository:
  ...
  url: ""
generated:
  timestamp: 2025-03-23T02:50:01.042Z
  tool: FlatRepo
statistics:
  totalFiles: 26
  totalLines: 2462
...
export const getContacts = async () => {
  try {
    ...
    const response = await fetch('https://cors-anywhere.herokuapp.com/https://entermocks.vercel.app/api/contacts');
...
const ContactDetailPage = () => {
  ...
  useEffect(() => {
    const fetchContact = async () => {
      try {
        ...
        setError('Error al obtener los detalles del contacto');
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div>
      ...
      <p>Compañía: {contact.company || 'No disponible'}</p>
      <p>Cumpleaños: {contact.birthday || 'No disponible'}</p>
...
const ContactForm = ({ onAddContact }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <button type="submit" disabled={!fullname || !phonenumber || !email || Object.keys(errors).length > 0}>
        Guardar
      </button>
